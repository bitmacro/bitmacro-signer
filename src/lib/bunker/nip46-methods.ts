 ...
 * Outbound `sendNostrConnectInitiate` encrypts the **NIP-46 response** `{ id, result: secret, error }` (not an RPC request) with **NIP-44**, matching [NIP-46](https://github.com/nostr-protocol/nips/blob/master/46.md).
 */
