...
export function VaultBackupGate({
  ...
  const pdfCopy: BackupPdfCopy = useMemo(
    () => ({
      ...
      didacticTitle: t("pdf.didacticTitle"),
      didacticBullets: t("pdf.didacticBullets").split("|"),
      ...
      qrSectionLead: t("pdf.qrSectionLead"),
      qrTitle: t("pdf.qrTitle"),
      jsonSectionTitle: t("pdf.jsonSectionTitle"),
      jsonSectionWarning: t("pdf.jsonSectionWarning"),
